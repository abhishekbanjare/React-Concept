    ...
    return (
        <div>
            ...
            <form className='w-50 mx-auto my-5' onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <input className="form-check-input" name="gender" value="Male" type="checkbox" onChange={getUserData} />
                    <label className="form-check-label">
                        Male
                    </label>
                </div>
                <div className="mb-3">
                    <input className="form-check-input" name="gender" value="Female" type="checkbox" onChange={getUserData} />
                    <label className="form-check-label">
                        Female
                    </label>
                </div>
